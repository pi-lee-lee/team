# winD 현재 상태 — 2026-08-18 10:00:07 자동 생성
...
| 시리얼 로그 성장 | 🟢 자라는 중 |
| 시리얼 마지막 줄 시각 | `10:00:06` |
| 시리얼 크기 | 521,778 B · 11,168 줄 |
...
| `txdrop` | 7 | `[TX-DROP]` |
| `txwait_skip` | 13 | `이번 주기는 건너뛴다` |
| `txwait_okto` | 2 | `T1 초과` |
| `busy` | 0  ⚠ 훑은 줄 11,168 | `"busy ` |
| `tx` | 2,133 | `[TX] ` |
| `sendok` | 2,131 | `"SEND OK"` |
| `ipd` | 0  ⚠ 훑은 줄 11,168 | `+IPD,` |
| `connect` | 5 | `online (CONNECT)` |
| `ipfound` | 5 | `★ IP 확보` |
| `cipstart_err` | 1 | `Unlink` |
| `stall` | 0  ⚠ 훑은 줄 11,168 | `★ 정지 감지` |

펌웨어 `[CNT]` 마지막 줄: `up=2940 drop=4 esprst=3 resync=6 sendfail=0 okto=2 stuck=2 ackq=0 ackdrop=0 slot=2450 oow=0 smiss=2 ssovf=2 cksumng=0 skip=13 online=1`
