# winE 현재 상태 — 2026-08-18 11:35:04 자동 생성
...
| 시리얼 로그 성장 | 🟢 자라는 중 |
| 시리얼 마지막 줄 시각 | `11:35:03` |
| 시리얼 크기 | 861,180 B · 18,809 줄 |
...
| 표지(줄 수) | 누계 | 찾은 문자열 |
|---|---|---|
| `fail3` | 0  ⚠ 훑은 줄 18,809 | `전송 3회 연속 실패` |
| `banner` | 1 | `[PARKING NODE]` |
| `espbanner` | 1 — **우리 DTR 1 / 사건 0** | `System Ready` |
| `zeroip` | 0  ⚠ 훑은 줄 18,809 | `"0.0.0.0"` |
| `txresync` | 0  ⚠ 훑은 줄 18,809 | `[TX-RESYNC]` |
| `txdrop` | 0  ⚠ 훑은 줄 18,809 | `[TX-DROP]` |
| `txwait_skip` | 7 | `이번 주기는 건너뛴다` |
| `txwait_okto` | 2 | `T1 초과` |
| `busy` | 0  ⚠ 훑은 줄 18,809 | `"busy ` |
| `tx` | 3,484 | `[TX] ` |
| `sendok` | 3,484 | `"SEND OK"` |
| `ipd` | 301 | `+IPD,` |
| `connect` | 1 | `online (CONNECT)` |
| `ipfound` | 1 | `★ IP 확보` |
| `cipstart_err` | 0  ⚠ 훑은 줄 18,809 | `Unlink` |
| `stall` | 0  ⚠ 훑은 줄 18,809 | `★ 정지 감지` |

펌웨어 `[CNT]` 마지막 줄: `up=4140 drop=0 esprst=0 resync=0 sendfail=0 okto=2 stuck=0 ackq=0 ackdrop=0 slot=3450 oow=295 smiss=0 ssovf=0 cksumng=0 skip=7 online=1`
