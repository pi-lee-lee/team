# win4 현재 상태 — 2026-08-17 12:46:02 자동 생성
...
| 시리얼 로그 성장 | ⏳ 첫 주기 |
| 시리얼 마지막 줄 시각 | `12:46:02` |
| 시리얼 크기 | 2,974,941 B · 63,570 줄 |
...
| `txdrop` | 69 | `[TX-DROP]` |
| `txwait_skip` | 78 | `이번 주기는 건너뛴다` |
| `txwait_okto` | 25 | `상한 초과` |
| `busy` | 69 | `"busy ` |
| `tx` | 15,581 | `[TX] ` |
| `sendok` | 15,580 | `"SEND OK"` |
| `ipd` | 0  ⚠ 훑은 줄 63,570 | `+IPD,` |
| `connect` | 6 | `online (CONNECT)` |
| `ipfound` | 8 | `★ IP 확보` |
| `cipstart_err` | 3 | `Unlink` |
| `stall` | 2 | `★ 정지 감지` |

펌웨어 `[CNT]` 마지막 줄: `up=17581 drop=4 esprst=4 resync=6 sendfail=0 okto=25 skip=78 online=1`
