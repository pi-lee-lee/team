# win4 현재 상태 — 2026-08-17 08:35:38 자동 생성
...
| 시리얼 로그 성장 | 🟢 자라는 중 |
| 시리얼 마지막 줄 시각 | `08:35:37` |
| 시리얼 크기 | 436,492 B · 9,509 줄 |
...
| `txdrop` | 5 | `[TX-DROP]` |
| `txwait_skip` | 6 | `이번 주기는 건너뛴다` |
| `txwait_okto` | 1 | `상한 초과` |
| `busy` | 2 | `"busy ` |
| `tx` | 2,334 | `[TX] ` |
| `sendok` | 2,334 | `"SEND OK"` |
| `ipd` | 0  ⚠ 훑은 줄 9,509 | `+IPD,` |
| `connect` | 2 | `online (CONNECT)` |
| `ipfound` | 2 | `★ IP 확보` |
| `cipstart_err` | 0  ⚠ 훑은 줄 9,509 | `Unlink` |
| `stall` | 0  ⚠ 훑은 줄 9,509 | `★ 정지 감지` |

펌웨어 `[CNT]` 마지막 줄: `up=2580 drop=1 esprst=1 resync=3 sendfail=0 okto=1 skip=6 online=1`
