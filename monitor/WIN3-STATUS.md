# 창2 현재 상태 — 2026-08-17 00:24:01 자동 생성
...
| 시리얼 로그 성장 | ⏳ 첫 주기 |
| 시리얼 마지막 줄 시각 | `00:24:00` |
| 시리얼 크기 | 10,357 B · 226 줄 |
...
펌웨어 `[CNT]` 마지막 줄: `up=60 drop=0 esprst=0 resync=0 sendfail=0 okto=0 skip=0 online=1`
