...
// 🔑 **`[USD]` 를 뺐다** (2026-08-20 23:xx). 임무가 끝난 계측기다 —
//   흔들림 폭이 `.near()` 여유(40cm)와 `NO_READ_RELEASE_N`(3) 을 유도했고 그 값은 상수에 박혔다.
//   ⚠ B1 물리 불안정 판정에 쓰인 값(폭 52 · 93.8% 못 잼)은 `INTERVENTIONS.md` 에 남아 있다.
//   🔴 뺀 이유는 **RAM** 이다 — 센서 부하 측정에 13개를 등록하면 48B 가 아깝다.
//     그리고 그 측정의 정본은 `up/slot`(슬롯 주기)이고 **폭이 아니다.**
